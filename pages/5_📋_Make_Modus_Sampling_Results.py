...
with st.expander("Add subsoils", expanded=False):
    ...
    st.markdown("<span style='color: Yellow;'>The addition of subsoil results is currently a work in progress. The subsoil values will not be included in the resulting XML file.</span>", unsafe_allow_html=True)
